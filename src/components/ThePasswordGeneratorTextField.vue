...
<template>
  ...
  <div class="password-display box cluster center">
    <input type="text" name="generated-password" id="generated-password" readonly="true" aria-readonly="true" value=""
      placeholder="P4$5W0rD!">
    <div class="button cluster">
      <span v-if="isPasswordCopied">COPIED</span>
      <button class="button-copy" type="button"><svg width="21" height="24" xmlns="http://www.w3.org/2000/svg">
          <path
